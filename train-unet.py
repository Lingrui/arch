...
flags = tf.app.flags
FLAGS = flags.FLAGS
flags.DEFINE_string('db', 'D.db', '')
flags.DEFINE_integer('classes', 7, 'D has 7 classes')
flags.DEFINE_string('mixin', None, '')
flags.DEFINE_string('val', None, '')
flags.DEFINE_string('net', 'myunet', '')
...
flags.DEFINE_string('model', 'D_model', 'Directory to put the training data.')
